...
func init() {
	...
	templates["index"] = template.Must(template.ParseFiles("chapter5/htmltemp/templates/index.html",
		"chapter5/htmltemp/templates/base.html"))
	templates["add"] = template.Must(template.ParseFiles("chapter5/htmltemp/templates/add.html",
		"chapter5/htmltemp/templates/base.html"))
	templates["edit"] = template.Must(template.ParseFiles("chapter5/htmltemp/templates/edit.html",
		"chapter5/htmltemp/templates/base.html"))
}

//Render templates for the given name, template difinition and data object
...
func saveNote(w http.ResponseWriter, r *http.Request) {
	...
	//incerement the value of id for generating key for the map
	id++
